-- Quick Update: Change Proximity Validation from 100m to 2000m
-- Run this in your Supabase SQL Editor to immediately fix the proximity issue
...
-- Confirm the update
SELECT 'Proximity validation successfully updated to 2000 meters!' as status;
