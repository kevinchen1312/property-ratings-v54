...
-- Minimal version using only existing columns
...
BEGIN
    ...
    -- First, create the fake users in app_user table (minimal columns)
    RAISE NOTICE '';
    ...
    FOR i IN 1..15 LOOP
        ...
        -- Insert user if they don't already exist (only id and email)
