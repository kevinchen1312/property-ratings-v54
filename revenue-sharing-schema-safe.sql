-- Revenue Sharing System Database Schema (Safe Version)
-- Run this in your Supabase SQL Editor - handles existing policies gracefully
...
CREATE TABLE IF NOT EXISTS property_contributors (
  ...
  -- Ensure one record per user per property
...
-- Drop existing trigger first (before dropping function it depends on)
