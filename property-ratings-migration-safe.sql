-- Property Ratings App - Safe Migration (handles existing objects)
...
-- Create app_user table (drop and recreate if exists)
...
ON rating (user_id, property_id, attribute, (created_at::date));
...
-- Success message
SELECT 'Property Ratings database schema created successfully!' as result;
